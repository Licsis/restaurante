        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="navbar-buttons mbr-section-btn">
                  ...
                  <a class="btn btn-warning display-4" href="alta_impuesto1.html">Crear <br> Impuesto</a>
              </div>
            </div>
        </div>
    </nav>
  ...
  <table>
    ...
    <tbody>
          <?php
            ...
            $sql = "SELECT * FROM impuestos ORDER BY ID_impuesto DESC";
            ...
            while ($datos = mysqli_fetch_array($resultado)) {
              ...
              echo "<tr>";
                ...
                echo "<td id='acciones'>";
                        ...
                        echo '<a id="boton1" class="mbri-trash mbr-iconfont mbr-iconfont-btn" href="baja_impuesto.php?ID_impuesto='.$id.'" title="Borrar Impuesto"  onClick="confirm("¿Borrar el Menu?")">                     
                        ...
                        echo '<a id="boton2" class="mbri-trash mbr-iconfont mbr-iconfont-btn" href="modificar_impuesto1.php?ID_impuesto='.$id.'" title="Modificar Impuesto"> 
