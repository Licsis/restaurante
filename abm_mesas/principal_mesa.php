      ...
      <?php
        ...
        while ($datos = mysqli_fetch_array($resultado)) {
          ...
          echo "<tr>";
                ...
                echo "<td>";
                if ($capacidad >= 2) {
                  echo $capacidad." personas";
                }else {
                  echo $capacidad." persona";
                }      
                
                echo "</td>";
                echo "<td id='acciones'>";
                        //creo botones para modificar y borra un menú también incluyo iconos .SVG de Font Awesom
                        echo '<a id="boton1" class="mbri-trash mbr-iconfont mbr-iconfont-btn" href="baja_mesa.php?ID_mesa='.$id.'" title="Borrar Mesa"  onClick="confirm("¿Borrar el Menu?")">                     
                        ...
                        echo '<a id="boton2" class="mbri-trash mbr-iconfont mbr-iconfont-btn" href="modificar_mesa1.php?ID_mesa='.$id.'" title="Modificar mesa"> 
...
<section data-bs-version="5.1" class="footer7 cid-tRJwh98X4c mbr-reveal" once="footers" id="footer7-1j" style="height: 8rem; position: fixed;width: 100%; z-index: 1;">
